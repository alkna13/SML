...
loadData <- function()
{
  ...
  x_l= loadMultiplePersonsData(300,3,6,"A:/Machine_Learning/2017/group")#loading group 3-8 takes ca. 30 min -->  19:56h
...
exercise2_1_3 <- function()
{
  ...
  for(k in kstart:(kstart+kruns-1))
  {
    ...
    print(k)
    #the following part is only to compare the PCA processed data with the unprocessed data (not necessary for report)
    # 
    # t_time<-proc.time()
